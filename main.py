...
def attack(char_name: str, char_class: str) -> str:
    """Функция передает значения атаки для каждого персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция передает значения блока для каждого персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция передает значения умения для каждого персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описание персонажей.Выбор персонажа."""
    approve_choice = None
    char_class = None
